package rickkeiAcademy.model.product;
...
public class Product implements Serializable {
    ...
    public void inputDataProduct(List<Producer> list) {
        ...
        setProductName(Config.scanner().nextLine());
        ...
        setTitle(Config.scanner().nextLine());
        System.out.println("Nhập giá xe :");
        setPrice(Config.scanner().nextInt());
        System.out.println("Nhập trạng thái xe :");
        setProductStatus(Config.scanner().hasNextBoolean());
    }
